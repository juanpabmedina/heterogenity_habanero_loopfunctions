...
n_exp = 10
file_path = '/home/robotmaster/argos3-installation/habanero/habanero-loopfunctions/scenarios/communication/data/score_aggregation.txt'
os.remove(file_path)
data_score = []
...
exp_name = 'aggregation4_habanero_20%'
