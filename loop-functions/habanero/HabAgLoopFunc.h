...
#ifndef HAB_AG_LOOP_FUNC
#define HAB_AG_LOOP_FUNC
...
class HabAgLoopFunction: public CoreLoopFunctions {
  public:
    HabAgLoopFunction();
    HabAgLoopFunction(const HabAgLoopFunction& orig);
    virtual ~HabAgLoopFunction();
