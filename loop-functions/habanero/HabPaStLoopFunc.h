...
#ifndef HAB_PA_ST_LOOP_FUNC
#define HAB_PA_ST_LOOP_FUNC
...
class HabPaStLoopFunction: public CoreLoopFunctions {
  public:
    HabPaStLoopFunction();
    HabPaStLoopFunction(const HabPaStLoopFunction& orig);
    virtual ~HabPaStLoopFunction();
