...
#ifndef HAB_ST_LOOP_FUNC
#define HAB_ST_LOOP_FUNC
...
class HabStLoopFunction: public CoreLoopFunctions {
  public:
    HabStLoopFunction();
    HabStLoopFunction(const HabStLoopFunction& orig);
    virtual ~HabStLoopFunction();
