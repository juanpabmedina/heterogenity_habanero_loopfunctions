...
#ifndef HAB_HZ_REV_LOOP_FUNC
#define HAB_HZ_REV_LOOP_FUNC
...
class HabHzRevLoopFunction: public CoreLoopFunctions {
  public:
    HabHzRevLoopFunction();
    HabHzRevLoopFunction(const HabHzRevLoopFunction& orig);
    virtual ~HabHzRevLoopFunction();
